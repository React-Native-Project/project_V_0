...
const ExercisesTypes = (props) => {
  ...
  return (
    ...
    <View style={{ backgroundColor: "#c71875", width: "100%", height: "100%" }}>
      <ScrollView>
        <Grid style={{ marginTop: 60 }}>
          <Row>
            <Col >
              <TouchableOpacity onPress={() => this.onPress("ExercisesPage")}>
            ...
            <Col >
              <TouchableOpacity onPress={() => this.onPress("ExercisesPage1")}>
                <Image style={{ width: 150, height: 210, borderRadius: 100, margin: 8 }}
          ...
          <Col style={{ alignSelf: "center" }}>
            <TouchableOpacity onPress={() => this.onPress("ExercisesPage2")} >
